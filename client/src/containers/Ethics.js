        ...
        <div className={Classes.Ethics}>
            <div className={Classes.EthicsForm}>
                ...
                <div className={Classes.ParagraphContainer}>
                    <p><b>Nature of the study.&nbsp;</b>You are about to participate in an experiment in which you will travel to fictional villages that each received a catch of fish from a space fisherman fishing on either a blue or red planet. For each village, you have to judge whether the spacefisherman travelled the blue or red planet to catch their fish. After the experiment, we will ask you you to provide some basic demographics (e.g., age/sex etc). Your session should last for around 10 minutes and your responses will be recorded. You will be given full instructions shortly and will be able to ask any questions you may have.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
                    <p><b>Compensation.&nbsp;</b> You will be paid $1.50 + up to $2.00 bonus based on your performance.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
