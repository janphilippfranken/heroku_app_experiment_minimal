        ...
        <div className={Classes.Ethics}>
            ...
            <div className={Classes.EthicsForm}>
                ...
                <div className={Classes.ParagraphContainer}>
                    <p><b>Nature of the study.&nbsp;</b>You are about to participate in an experiment in which you will travel to fictional space stations to advice the local crew on how to cook space fish.  For each space station, you have to judge whether the station's local supplier travelled a blue or red planet to catch their fish. After the experiment, we will ask you to provide some basic demographics (e.g., age). Your session should last for around 10-15 minutes and your responses will be recorded. You will be given full instructions shortly and will be able to ask any questions you may have.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
                    <p><b>Compensation.&nbsp;</b> You will be paid £1.00 for your participation + up to $£2.50 bonus based on your performance.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
                    <p><b>Risks and benefits.&nbsp;</b><b>Risks and benefits.&nbsp;</b>There are no known risks to participation in this study. Other than the payment mentioned, there no tangible benefits to you, however you will be contributing to our knowledge about information integration.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
