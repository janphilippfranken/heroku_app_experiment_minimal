    ...
    return (
        <div className={Classes.Ethics}>
            ...
            <div className={Classes.EthicsForm}>
                ...
                <div className={Classes.ParagraphContainer}>
                    <p><b>Risks and benefits.&nbsp;</b>There are no known risks to participation in this study. Other than the payment mentioned, there are no tangible benefits to you, however you will be contributing to our knowledge about information integration.</p>
                </div>
                <div className={Classes.ParagraphContainer}>
