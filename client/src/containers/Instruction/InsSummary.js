    ...
    return (
        <div className={Classes.InsSummary}>
            <div className={Classes.InnerContainer}>
                ...
                6. You will then provide a guess about the villagers' relationships with each other, and, under condieration of their beliefs, select the planet you think the space fisherman travelled. You will also rate your confidence.<br></br><br></br>
