    ...
    return (
        <div className={Classes.InsOverview}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <p>
                    <b>Important:</b> RED fish have to be cooked with <b>TABLE SALT</b>, while BLUE fish have to be cooked with <b>HIMALAYAN SALT</b>. If cooked with the wrong salt or no salt, a fish will become <b>toxic</b> and thus inedible.</p><br></br>
