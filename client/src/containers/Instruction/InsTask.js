    ...
    return (
        <div className={Classes.InsTask}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <p>Your task is to <b>decide</b> whether the space fisherman travelled the RED or BLUE planet to catch their fish. You will be paid a bonus of £0.50 each time you selected the correct planet (max. bonus = 4 * £0.50 cent = £2.00).</p><br></br>
