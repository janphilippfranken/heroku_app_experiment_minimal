        ...
        <div className={Classes.InsQuiz}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <div className={Classes.QuizContainer}>
                    ...
                    <li className={Classes.Q4}>4. You will talk to two crew members to learn which planet they believe the fisherman travelled. <b>Their beliefs are valuable</b> to you as they can <b>improve your chances</b> of selecting the right planet and thus giving the right salt advice.</li>
