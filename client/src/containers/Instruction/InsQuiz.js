        ...
        <div className={Classes.InsQuiz}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <div className={Classes.QuizContainer}>
                    ...
                    <li className={Classes.Q5}>5. The two villagers might talk to each other and influence their beliefs. Also, you do not know when the two villagers received their fish.</li>
